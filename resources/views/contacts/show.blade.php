                        ...
                        <div class="container px-5 py-10 mx-auto">
                            ...
                            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="p-2 w-full">
                                        <button class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg"><a href="{{route('contacts.edit', ['contact', $contact->id])}}"></a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
